...
if(isset($_POST['check_out']))
{
  ...
  $query="insert into payment(cust_id,dop,top,fname,lname,email,address,state,country,zip,card_type,card_name,card_num,card_exp,card_cvv,amt_paid) values ('$cust_id','$dop','$top','$fname','$lname','$email','$address','$state','$country','$zip','$card_type','$card_name','$card_num','$card_exp','$card_cvv','10000')";
  $res=mysqli_query($con,$query);
   ...
   {
     header('location:checkout12.php');
   }
}
 ?>
</script>
    ...
    <div class="col-md-4 order-md-2 mb-4">
      ...
      <ul class="list-group mb-3">
        <li class="list-group-item d-flex justify-content-between lh-condensed">
          <div>
            <h6 class="my-0">Yearly Membership</h6>
            <small class="text-muted">Valid for a Year</small>
          </div>
          <span class="text-muted">INR 8,200</span>
        </li>
        <li class="list-group-item d-flex justify-content-between lh-condensed">
          <div>
          ...
          <span class="text-muted">INR 1,800</span>
        </li>
      ...
      <form class="needs-validation" action="" method="POST" novalidate>
        ...
        <div class="col-md-4 mb-3">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="" name="card_num" class="form-control" id="cc-number" placeholder="" required>
            <div class="invalid-feedback">
        ...
        <hr class="mb-4">
        <button class="btn btn-primary btn-lg btn-block" type="submit" id="success" name="check_out">Continue to checkout</button>
      </form>
    </div>
  </div>
